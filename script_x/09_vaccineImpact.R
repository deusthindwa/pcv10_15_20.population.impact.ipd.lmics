...
#save combined plots
ggsave(here("output", "fig3a_vaccineimpact.png"),
       plot = (D), 
...
#save combined plots
ggsave(here("output", "sfig8a_vaximpact.png"),
       plot = (E), 
       width = 24, height = 12, unit = "in", dpi = 300)
...
#save combined plots
ggsave(here("output", "fig3b_vaccineimpact.png"),
       plot = (F), 
       width = 24, height = 12, unit = "in", dpi = 300)
...
#save combined plots
ggsave(here("output", "sfig8b_vaximpact.png"),
       plot = (H), 
       width = 24, height = 12, unit = "in", dpi = 300)
